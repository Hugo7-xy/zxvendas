...
export function init(dependencies) {
    console.log("Sistema de Referências inicializado.");
    db = dependencies.db;

    // A página de referências está escondida no início.
    // Carrega as referências apenas na primeira vez
    // que o usuário clica na aba "Referências".
